...
@section('head_style')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('Modules/BlockIo/Resources/assets/admin/css/crypto_transaction.css') }}">
@endsection
...
@section('page_content')
                    ...
                    <div class="col-md-12">
                        <div class="d-flex flex-wrap justify-content-between">
                            <div class="d-flex flex-wrap">
                                ...
                                <!-- Currency -->
                                <div class="pr-25">
                                    <label for="currency">{{ __('Crypto Currency') }}</label><br>
    ...
    <div class="row">
        <div class="col-md-8">
            <h3 class="panel-title text-bold ml-5">{{ __('All Crypto Received Transactions') }}</h3>
        </div>
        <div class="col-md-4">
...
<script src="{{ asset('Modules/BlockIo/Resources/assets/admin/js/crypto_received_transaction.min.js') }}" type="text/javascript"></script>

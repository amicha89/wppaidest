...
class CurrencyPaymentMethodController extends Controller
{
    ...
    public function paymentMethodList($tab, $id)
    {
        ...
        if (empty($data['currency'])) {
            $this->helper->one_time_message('error', __('Payment method settings not found.'));
    ...
    public function updatePaymentMethodCredentials(Request $request)
    {
        ...
        $this->helper->one_time_message('success', __('Payment method settings updated successfully.'));
            ...
            if ($request->hasFile('bank_logo')) {
                ...
                if (isset($bank_logo)) {
                    ...
                    if ($extension == 'png' || $extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'bmp' || $extension == 'ico') {
                        ...
                        $this->helper->one_time_message('error', __('This image format is invalid.'));
                    }
                }
            }
    ...
    public function deleteBankLogo(Request $request)
    {
        if (isset($request->file_id)) {
            ...
            if ($file && $bank) {
                ...
                $data['success'] = 1;
                $data['message'] = __('Bank logo has been deleted successfully.');
            } else {
                $data['success'] = 0;

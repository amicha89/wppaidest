                    ...
                    <div class="col-sm-6">
                      ...
                      @if (isset($result['logo']))
                          <div class="position-relative">
                            <img src='{{ url('public/images/logos/'. $result['logo']) }}' width="250" height="66" id="logo-preview">
                            <span class="remove_img_preview_site_logo"></span>
                          </div>
                      @else
                        <img src='{{ url('public/uploads/userPic/default-logo.jpg') }}' width="250" height="66" id="logo-demo-preview">
                      @endif
                    </div>
                  </div>

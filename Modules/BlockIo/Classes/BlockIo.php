...
class BlockIo
{
    ...
    {
        return $this->blockIoAssetApiLog->with(['wallet:id,user_id'])->where(['payment_method_id' => BlockIo, 'object_type' => 'wallet_address'])->whereRaw('payload REGEXP ?', ['[[:<:]]' . $receiverAddress . '[[:>:]]'])
        ->first(['object_id']);
    }

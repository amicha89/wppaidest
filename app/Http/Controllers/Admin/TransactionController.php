...
class TransactionController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (module('CryptoExchange')) {
            $crypto_relation = 'crypto_exchange:id,receiver_address,file_name,receiving_details,payment_details,exchange_rate,to_currency,email_phone,verification_via';
        ...
        if (module('CryptoExchange') && isset($transaction->crypto_exchange) && !empty($transaction->crypto_exchange)){
            ...
            if (isset($transaction->crypto_exchange->receiving_details) &&  !empty($transaction->crypto_exchange->receiving_details)) {
                $data['receiving_details'] = $transaction->crypto_exchange->receiving_details;
            }
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->type == 'Crypto Exchange' || $request->type == 'Crypto Buy' || $request->type == 'Crypto Sell') {
            ...
            $cryptoSuccessMsg = str_replace('{soft_name}', settings('name'), $cryptoSuccessMsg);

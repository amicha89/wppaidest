    ...
    function getMerchantAndUserNetworkAddressWithMerchantBalance(userId)
    {
        ...
        .done(function(res)
        {
            if (res.status == 401) {
                ...
                $('#user-div').after( `<div class="form-group" id="merchant-address-div">
                ...
                if ((confirmationCryptoSentUrl == previousCrytoSentUrl) && cryptoSendAmount != null) {
                    ...
                    $('#user-address-div').after( `<div class="form-group" id="amount-div">
                        ...
                        <div class="col-sm-6" id="amount-input-div">
                            <input type="text" class="form-control amount" name="amount" placeholder="0.00000000" id="amount" value="${cryptoSendAmount}" onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)" required data-value-missing="${requiredField}"/>

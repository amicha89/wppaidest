    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="pull-right">
                <h3 class="user-full-name">{{ __('Username') }}</h3>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('admin.crypto_send.confirm') }}" class="form-horizontal" id="admin-crypto-send-form" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" id="network-div">
                            <label class="col-sm-3 control-label" for="user">{{ __('Network') }}</label>
                            <div class="col-sm-6">
                                <input class="form-control network" data-type="{{ $currency->type }}" name="network" type="text" value="{{ $network }}" id="network" readonly>
                            </div>
                        </div>

                        <!-- User -->
                        <div class="form-group" id="user-div">
                            <label class="col-sm-3 control-label" for="user">{{ __('User') }}</label>
                            <div class="col-sm-6">
                                <select class="form-control sl_common_bx" name="user_id" id="user_id" required data-value-missing="{{ __("This field is required.") }}">

...
@section('head_style')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('public/backend/currency-payment-method/list.min.css')}}">
...
@section('page_content')
	...
	<div class="box">
		<div class="box-body">
			<div class="dropdown">
				<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">{{ __('Currency') }} : <span class="currencyName">{{ $currency->name }}</span>
...
@push('extra_body_scripts')
	...
	<script src="{{ asset('public/backend/currency-payment-method/list.min.js')}}" type="text/javascript"></script>
	@if (config('mobilemoney.is_active') && $list_menu == 'mobilemoney')
		<script>
			'use strict';

...
<div class="row">
    <div class="col-md-2">
        <button type="button" class="btn btn-theme active mt-15">{{ __('Crypto Send') }}</button>
    </div>
                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 pull-left">{{ __('Sent Amount') }}</div>
                        ...
                        <div class="ml-0">
                            <div class="float-left">
                                <a href="#" class="admin-user-crypto-send-confirm-back-link">
                                    <button class="btn btn-theme-danger admin-user-crypto-send-confirm-back-btn"><strong><i class="fa fa-angle-left"></i>&nbsp;&nbsp;{{ __('Back') }}</strong></button>
                                </a>
                            </div>
                            <div class="float-right">
                                <form action="{{ route('admin.crypto_send.success') }}" method="POST" accept-charset="UTF-8" id="admin-user-crypto-send-confirm" novalidate="novalidate">
                                    ...
                                    <button type="submit" class="btn btn-theme" id="admin-user-crypto-send-confirm-btn">

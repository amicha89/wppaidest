                ...
                <form action="{{ route('admin.blockio_asset.update', encrypt($cryptoAssetSetting->network)) }}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="edit-blockio-network-form">
                    ...
                    <div class="box-body">                 
                        ...
                        <div class="form-group" id="name-div">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="name" class="form-control" value="{{ $cryptoAssetSetting->currency->name }}" placeholder="{{ __('eg - Bitcoin or Litecoin') }}" id="name" aria-required="true" aria-invalid="false">
                        ...
                        <div class="form-group" id="crypto-networks-div">
                            ...
                            <div class="col-sm-6">
                                <input type="text" value="{{ $cryptoAssetSetting->network }}" name="network" class="form-control" placeholder="{{ __('Enter network code (eg - BTC)') }}" id="network">
                        ...
                        <div class="form-group d-none" id="symbol-div">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="symbol" class="form-control" value="{{ $cryptoAssetSetting->currency->symbol }}" placeholder="{{ __('Symbol (ex - ₿)') }}" id="symbol" aria-required="true" aria-invalid="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control api_key" name="api_key" type="text" placeholder="{{ __('Please enter valid api key') }}" value="{{ json_decode($cryptoAssetSetting->network_credentials)->api_key }}" id="api_key">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control pin" name="pin" type="text" placeholder="{{ __('Please enter valid pin') }}" value="{{ json_decode($cryptoAssetSetting->network_credentials)->pin }}" id="pin">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control address" name="address" type="text" placeholder="{{ __('Please enter valid merchant address') }}" value="{{ json_decode($cryptoAssetSetting->network_credentials)->address }}" id="address">
                        ...
                        <div class="form-group" id="create-network-address-div">
                            <label class="col-sm-3 control-label" for="inputEmail3">{{ __('Create Addresses') }}</label>
                            <div class="col-sm-6">
                        ...
                        <div class="box-footer">
                            ...
                            @if (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_crypto_asset'))
                                <button type="submit" class="btn btn-theme pull-right" id="blockio-settings-edit-btn">

...
<div class="form-group">
    <label class="col-sm-3 control-label" for="stripe[secret_key]">{{ __('Secret Key') }}</label>
    <div class="col-sm-6">

        <input class="form-control" name="stripe[secret_key]" type="text" placeholder="{{ __('Stripe Secret Key') }}"
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="stripe[publishable_key]">{{ __('Publishable Key') }}</label>
    <div class="col-sm-6">

        <input class="form-control" name="stripe[publishable_key]" type="text" placeholder="{{ __('Stripe Publishable Key') }}"

            ...
            switch ($transaction->transaction_type_id)
            {
                ...
                case (module('BlockIo') ? Crypto_Sent : false):
                    ...
                    $data['html'] .= "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        ...
                                        "<div>" . moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)) . "</div>" .
                                    "</div>" .
                                    ...
                                    "<div class='d-flex justify-content-between flex-wrap mt-2'>" .
                                        "<div>" . __('Total') . "</div>" .
                                        "<div>" . moneyFormat($transaction->currency->symbol, formatNumber($transaction->total - $network_fee, $transaction->currency_id)) . "</div>" .
                                    "</div>" ;

                    $data['total'] =  "<div class='text-center '>
                                            <h2 class='text-white text-center font-weight-700 text-20'>" .  __('Sent Amount')  . "</h2>
                                            <h1 class='text-white mt-4'><strong>". moneyFormat($transaction->currency->symbol, formatNumber($transaction->total - $network_fee, $transaction->currency_id)). "</strong></h1>
                                        </div>" .
                ...
                case (module('BlockIo') ? Crypto_Received : false):
                    ...
                    $data['total'] =  "<div class='text-center '>
                                            ...
                                            <h1 class='text-white mt-4'><strong>". moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal, $transaction->currency_id)). "</strong></h1>
                                        </div>" .

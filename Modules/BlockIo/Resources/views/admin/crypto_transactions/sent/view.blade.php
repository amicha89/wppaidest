                                    ...
                                    <div class="mt-4 p-4 bg-secondary rounded shadow">
                                        ...
                                        @if ($transaction->currency)
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <p class="form-control-static">{{ optional($transaction->currency)->code }}</p>
                                                </div>
                                            </div>
                                        @endif
                                ...
                                <div class="panel-body">
                                    <div class="mt-4 p-4 bg-secondary rounded shadow">
                                        ...
                                        <div class="form-group total-deposit-feesTotal-space">
                                            <label class="control-label col-sm-6" for="fee">{{ __('Network Fees') }}
                                            </label>
                                            <div class="col-sm-6">
                                                <p class="form-control-static">
                                        ...
                                        @if ($transaction->total)
                                            <div class="form-group total-deposit-space">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="form-control-static">
                                                        {{ moneyFormat($transaction->currency->symbol, ($transaction->subtotal + (isset($network_fee) ? formatNumber($network_fee, $transaction->currency_id) : formatNumber(0.00000000, $transaction->currency_id)))) }}
                                                    </p>
                                                </div>
                                            </div>
                                        @endif

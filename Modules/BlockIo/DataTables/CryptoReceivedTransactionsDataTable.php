    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->editColumn('txid', function ($transaction) {
                ...
                return '<a href="' . route('admin.crypto_received_transaction.view', $transaction->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-eye-open" title="View"></i></a>&nbsp;';    
            })

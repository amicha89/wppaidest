...
<script>
    'use strict';
    var utilsScriptLoadingPath = '{{ theme_asset("public/js/intl-tel-input-13.0.0/build/js/utils.js") }}';
...
<script src="{{ asset('public/user_dashboard/js/user_custom.min.js')}}" type="text/javascript"></script>
@endsection

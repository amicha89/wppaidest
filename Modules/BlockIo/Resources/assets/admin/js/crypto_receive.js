    ...
    function getUserNetworkAddressBalanceWithMerchantAddress(userId)
    {
        ...
        .done(function(res) {
            ...
            if (res.status == 401) {
                ...
                //user-address-div
                $('#user-div').after( `<div class="form-group" id="user-address-div">
                ...
                $('#user-address-div').after( `<div class="form-group" id="user-balance-div">
                    <label class="col-sm-3 control-label" for="user-balance">${userCryptoBalance}</label>
                    <div class="col-sm-6">
                ...
                if ((confirmationCryptoReceiveUrl == previousReceivedUrl) && cryptoReceiveAmount != null) {
                    ...
                    $('#merchant-address-div').after( `<div class="form-group" id="amount-div">
                        <label class="col-sm-3 control-label require" for="Amount">${cryptoReceivedAmount}</label>
                        <div class="col-sm-6" id="amount-input-div">
                            <input type="text" class="form-control amount" name="amount" placeholder="0.00000000" id="amount" value="${cryptoReceiveAmount}" onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnInput(this)" required data-value-missing="${requiredField}"/>

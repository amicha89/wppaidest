...
<div class="form-group">
	<label class="col-sm-3 control-label" for="paypal[client_id]">{{ __('Client ID') }}</label>
	<div class="col-sm-6">
		<input class="form-control" name="paypal[client_id]" type="text" placeholder="{{ __('PayPal Client ID') }}"
...
<div class="form-group">
	<label class="col-sm-3 control-label" for="paypal[client_secret]">{{ __('Client Secret') }}</label>
	<div class="col-sm-6">
		<input class="form-control" name="paypal[client_secret]" type="text" placeholder="{{ __('PayPal Client Secret') }}"
...
<!-- paypal - Mode -->
<div class="form-group">
	<label class="col-sm-3 control-label" for="paypal[mode]">{{ __('Mode') }}</label>
	<div class="col-sm-6">
